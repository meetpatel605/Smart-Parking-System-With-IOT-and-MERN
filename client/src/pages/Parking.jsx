...
const Parking = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <form onSubmit={findAvailable} className="card mb-8 space-y-4">
        <div>
        ...
        <button className="btn-primary w-full" disabled={searching}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
          {slots.map((slot) => (
            <ParkingSlotCard
              ...
              onClick={(s) => {
                if (s.status === "available") setSelectedSlot(s);
              }}
            />
          ))}
        </div>
